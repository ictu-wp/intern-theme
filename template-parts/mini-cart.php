<div class="mini-cart-modal z-10 fixed inset-0 bg-gray-900 bg-opacity-50 items-center justify-center overflow-auto">
	<div id="minicart" class="bg-white w-[40%] rounded-lg mx-auto my-16">
		<div class="w-full flex-col justify-start items-start inline-flex">
			<div
				class="self-stretch px-6 py-4 bg-white border-b border-gray-200 justify-start items-center gap-2 inline-flex">
				<div id="minicart-close" class="w-10 h-10 justify-center items-center gap-2.5 flex">
			...
			<div
				class="self-stretch h-36 p-6 bg-white border-t border-gray-200 flex-col justify-start items-start gap-4 flex">
				...
				<div
					class="self-stretch h-12 px-6 bg-green-500 rounded-md justify-center items-center gap-2 inline-flex">
