...
add_filter(
	...
	<form method="get" action="<?php echo wc_get_page_permalink( 'shop' ); ?>"
		...
		<input name="s"
			class="h-full outline-none grow shrink basis-0 text-stone-300 text-sm font-normal font-['Be Vietnam Pro'] leading-tight" />
		<button type="submit"
			...
			<div class="text-white text-sm font-semibold font-['Be Vietnam Pro'] leading-none">
				<?php echo __( 'Search' ); ?>
			</div>
		</button>
	</form>
