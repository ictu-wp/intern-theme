...
<form class="rounded-md overflow-hidden w-full p-6 bg-white flex-col justify-start items-start gap-6 inline-flex"
	...
	<div class="w-full md:w-3/4 flex-col justify-start items-start gap-4 flex">
		<div class="w-full justify-start items-center gap-4 inline-flex">
			...
			<div class="w-full h-11 px-4 rounded-md border border-gray-200 justify-start items-center gap-2.5 flex">
		...
		<div class="w-full justify-start items-center gap-4 inline-flex">
			...
			<div
				class="w-full h-11 px-4 bg-neutral-100 rounded-md border border-gray-200 justify-start items-center gap-2.5 flex">
				<input type="email"
		...
		<div class="w-full justify-start items-center gap-4 inline-flex">
			<label for="billing_address_2" class="w-24 text-zinc-900 text-sm font-normal leading-tight">
				<?php echo __( 'Address' ); ?>
			</label>
