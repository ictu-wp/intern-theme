...
<div class="woocommerce-variation-add-to-cart variations_button">
	...
	<div class="w-full justify-start items-start gap-2 inline-flex flex-wrap md:flex-nowrap">
		<?php do_action( 'woocommerce_before_add_to_cart_button' ); ?>
		<button type="submit" name="add-to-cart"
			class="flex-grow md:w-56 h-14 px-4 rounded-md border border-green-500 justify-center items-center gap-2 inline-flex">
